...
class ProductRepoImpl implements ProductRepo {
  ...
  @override
  Future<Either<Failures, void>> addProduct(ProductEntity input)async {
  try{
    await dataBaseServices.addData(path: BackEndEndPoint.kAddProduct, data: ProductModel.fromEntity(input,ProductEntity).toJson());
